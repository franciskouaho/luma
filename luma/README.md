...
2. Activez les services suivants :
   - **Authentication** : Google Sign-In et Apple Sign-In
...
4. Mettez à jour également `app.json` avec vos credentials dans la section `extra`.

### Configuration Google OAuth

1. Créez un projet sur [Google Cloud Console](https://console.cloud.google.com)
2. Activez l'API Google+
3. Créez des credentials OAuth 2.0 pour :
...
- [ ] Support multilingue
- [ ] Intégration réelle de Llama AI via API
...
Les Cloud Functions sont dans le dossier `functions/` et utilisent Firebase Functions v2. Pour le moment, elles utilisent des données mockées pour le développement. Pour intégrer Llama AI en production :

1. Inscrivez-vous sur [Together AI](https://together.ai) ou [Replicate](https://replicate.com)
2. Obtenez une clé API
3. Modifiez `functions/src/llama.ts` pour appeler l'API réelle
4. Redéployez les functions
